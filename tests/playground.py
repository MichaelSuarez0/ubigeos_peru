...
if __name__ == "__main__":
    ...
    print(ubg.core._utils.fuzzy_validate("Nazca", ["Nasca", "Caminaca"]))
    print(ubg.validate_distrito("Nazca", fuzzy_match=True, on_error="raise"))
    print(ubg.validate_distrito("Nasca", fuzzy_match=True, on_error="raise"))